...
function initialize(longiParamFunc, latitParamFunc) {
	//Query passed parameters
	var longitude = longiParamFunc;
	var latitude = latitParamFunc;
    //Map parametrs
    var mapOptions = {
        zoom: 14,
		center: new google.maps.LatLng(longitude, latitude)/*41.154, -73.328)*/,
