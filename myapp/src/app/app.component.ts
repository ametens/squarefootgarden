/**
 * Specifies the class to Import (object)
 */
import { Component } from '@angular/core';

/**
 * Specifies the metadata of this object
 * This object is a component defined by the 
 * annotation (decorator) : @Component()
 */

@Component({

  //how the component is referenced - HTML tag in the template
  selector: 'app-root',

  //pointing to the template (view)
  templateUrl: './app.component.html',

  //attached stylesheet
  styleUrls: ['./app.component.css'],

  //Array of providers for services that the component requires
  providers: []
})
